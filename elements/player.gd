...
func _ready():
	...
	propulsion_center = preload("res://particles/player_propulsion.tscn").instantiate()
	...
	propulsion_left = preload("res://particles/player_propulsion.tscn").instantiate()
	...
	propulsion_right = preload("res://particles/player_propulsion.tscn").instantiate()
